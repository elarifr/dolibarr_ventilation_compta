...
$sql = "SELECT f.ref_supplier, f.rowid as facid, l.fk_product, l.description, l.total_ht , l.qty, l.rowid, l.tva_tx, c.intitule, c.numero, ";
...
{
  $sql .= " AND f.ref_supplier like '%".$_GET["search_facture"]."%'";
}
if ($typeid) {
  ...
  while ($i < min($num_lignes, $limit))
    {
      ...
      //Ref Invoice
      $facturefournisseur_static->ref=$objp->ref_supplier;
