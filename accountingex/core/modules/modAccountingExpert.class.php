...
class modAccountingExpert extends DolibarrModules {
	...
	function modAccountingExpert($DB) {
		...
		// elarifr we need accountingexpert folder to use $conf->accountingexpert->dir_output which report documents/accountingexpert directory
		$this->dirs = array(
			'/accountingex/temp',
		...
		// Elarifr 
		$this->const[47] = array("ACCOUNTINGEX_SELL_DETAILED","chaine","1");
		$this->const[48] = array("ACCOUNTINGEX_SELL_EXPORTZERO","chaine","0");
		$this->const[49] = array("ACCOUNTINGEX_EXPORT_FOLDER01","chaine","C:\%USERPROFILE%");
		$this->const[50] = array("ACCOUNTINGEX_EXPORT_FOLDER02","chaine","C:\mycompta");
		$this->const[51] = array("ACCOUNTINGEX_EXPORT_FILENAME_PREDATING","chaine","0");
		$this->const[52] = array("ACCOUNTINGEX_EXPORT_FILENAME","chaine","export");
		$this->const[53] = array("ACCOUNTINGEX_EXPORT_FILENAME_JOURNAL","chaine","1");
		$this->const[54] = array("ACCOUNTINGEX_EXPORT_FILENAME_POSTDATING","chaine","1");
		$this->const[55] = array("ACCOUNTINGEX_EXPORT_FILENAME_EXTENSION","chaine",".csv");
		$this->const[56] = array("ACCOUNTINGEX_EXPORT_FILENAME_SEPARATOR","chaine","_");
		// Elarifr
		// Css
	...
	//Elarifr
		...
		//Elarifr // should be enabled only if experimental modules are enabled
		$this->menu[$r] = array (
				'fk_menu'=> 'fk_mainmenu=accounting,fk_leftmenu=Journaux',
				'type'=>'left',
