...
/**
 *   	\file       accountingex/journal/cashjournal-sqlarray.php
 *		\ingroup    Accounting Expert
 *		\brief      included part of exportjournal.php , query & create data array
 */


// print $conf->entity . "include cash sqlarray ";
// CASHJOURNAL-SQLARRAY
...
//	$tabtype = array ();
    ...
    // controls
		...
		$bank_code_journal = (! empty ( $obj->code_journal) ? $obj->code_journal : $conf->global->ACCOUNTINGEX_CASH_JOURNAL);
